    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-12 col-12 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-city"> Daftar Kanban Karawang</h3></i>
                                    ...
                                    <div class="tab-pane active" id="fnd-gedung-a">
                                        <div class="table-responsive">
                                            <table id="dataTable" class="table table-bordered table-striped table-hover table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="align-middle text-uppercase text-center">Part Address</th>
                                                        <th class="align-middle text-uppercase text-center">Conveyance No</th>
													...
													if ($query) {
														while ($row = mysqli_fetch_array($query)) {															
															...
															<tr>
																...
																<td class="align-middle text-center"><?= $row['field_61'] ?></td>
																<td class="align-middle text-center"><?= $row['field_7'] ?></td>
																<td class="align-middle text-center">
																	<a href="?p=edit-karawang&id=<?= $row['id'] ?>" class='btn btn-primary btn-sm waves-effect waves-dark'><i class='mdi mdi-settings'> Edit</i></a>
																	<a href="?p=process-hapus-karawang&id=<?= $row['id'] ?>" class='btn btn-danger btn-sm waves-effect waves-dark'><i class='mdi mdi-delete'> Delete</i></a>
																	<a href="?p=process-cetak-data-karawang&id=<?= $row['id'] ?>" class='btn btn-success btn-sm waves-effect waves-dark' target='_blank'><i class='mdi mdi-printer'> Print</a></i>
																</td>
															</tr>
														<?php $i++; } 
													} ?>
                                            ...
                                            <div class="form-group">
                                                <a href="?p=tambah-karawang" class="btn btn-success waves-effect waves-dark"><i class="mdi mdi-plus-circle-outline"> ADD</button></a></i>
                                            </div>
                                        </div>
                                    </div>
													...
													if ($query) {
														while ($row = mysqli_fetch_array($query)) {
															...
															<tr>
																...
																<td class="align-middle text-right"><?= $row['field_17'] ?></td>
																<td class="align-middle text-center"><?= $row['field_14'] ?></td>
																<td class="align-middle text-right"><?= $row['field_13'] ?></td>
																<td class="align-middle text-center"><?= $row['field_11'] ?></td>
																<td class="align-middle text-center"><?= $row['field_61'] ?></td>
																<td class="align-middle text-center"><?= $row['field_7'] ?></td>
																<td class="align-middle text-center">
