	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-12 col-12 align-self-center">
				<h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-settings"> Edit Kanban Sunter (ADM)</h3></i>
								...
								<?php
									...
									if ($query) {
										while ($row = mysqli_fetch_array($query)) { ?>
											<form action="?p=process-edit-adm-sunter" method="post">
												...
												<div class="form-group">
													...
													<button class="btn btn-danger waves-effect waves-dark" type="button" onclick="location.href='?p=adm-sunter'"><i class="mdi mdi-refresh"> CANCEL</button></a></i>
												</div>
											</form>
										<?php
										}
