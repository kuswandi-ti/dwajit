    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-12 col-12 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-history"> History Print Daftar Kanban Karawang (ADM)</h3></i>
                                    ...
                                    <div class="tab-pane active" id="fnd-gedung-a">
                                        <div class="table-responsive">
                                            <table id="dataTable" class="table table-bordered table-striped table-hover table-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="align-middle text-uppercase text-center">Job No</th>
														<th class="align-middle text-uppercase text-right">Delivery Date</th>
                                                        <th class="align-middle text-uppercase text-center">Delivery Time</th>                                                        
                                                        <th class="align-middle text-uppercase text-center">Order No</th>
														<th class="align-middle text-uppercase text-center">PO Number</th>
                                                        <th class="align-middle text-uppercase text-center">Print Count</th>
													...
													if ($query) {
														while ($row = mysqli_fetch_array($query)) {
															...
															<tr>
																...
																<td class="align-middle text-center"><?= $row['field_26'] ?></td>
																<td class="align-middle"><?= $row['field_27'] ?></td>
																<td class="align-middle text-right"><?= $row['field_31'] ?></td>
																<td class="align-middle text-center"><?= $row['field_28'] ?></td>
																<td class="align-middle text-right"><?= $row['field_17'] ?></td>
																<td class="align-middle text-center"><?= $row['field_18'] ?></td>
																<td class="align-middle text-center"><?= $row['field_10'] ?></td>
																<td class="align-middle text-center"><?= $row['field_11'] ?></td>
																<td class="align-middle text-center"><?= $row['printed'] ?></td>
																<td class="align-middle text-center">
																	<!--<a href="?p=edit-history-adm-sunter&
																			  supplier_code1=<?= $row['supplier_code1'] ?>&
																			  supplier_code2=<?= $row['supplier_code2'] ?>&
																			  ...
																			  pcs_kanban=<?= $row['pcs_kanban'] ?>&
																			  dock_code=<?= $row['dock_code'] ?>&
																			  progress_lane1=<?= $row['progress_lane1'] ?>&
																			  progress_lane2=<?= $row['progress_lane2'] ?>&																			  
																			  conveyance_no=<?= $row['conveyance_no'] ?>&
																			  part_address=<?= $row['part_address'] ?>" class='btn btn-primary btn-sm waves-effect waves-dark'><i class='mdi mdi-settings'> Edit</a></i>
																	<a href="?p=process-hapus-history-adm-sunter&id=<?= $row['id'] ?>part_no=<?= $row['part_no'] ?>&part_name=<?= $row['part_name'] ?>" class='btn btn-danger btn-sm waves-effect waves-dark'><i class='mdi mdi-delete'> Delete</i></a>-->
																	<a href="?p=process-cetak-data-adm-sunter&id=<?= $row['id'] ?>" class='btn btn-success btn-sm waves-effect waves-dark' target='_blank'><i class='mdi mdi-printer'> Re-Print</i></a>
																</td>
															</tr>
														<?php $i++; } 
													} ?>
                                            ...
                                            <!--<div class="form-group">
                                                <a href="?p=tambah-history-sunter" class="btn btn-success waves-effect waves-dark"><i class="mdi mdi-plus-circle-outline"> ADD</button></a></i>
                                            </div>-->
                                        </div>
                                    </div>
