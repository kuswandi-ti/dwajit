    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-12 col-12 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-history"> History Print Daftar Kanban Sunter (TMMIN)</h3></i>
														...
														while ($row = mysqli_fetch_array($query)) {
															...
															<tr>
																...
																<td class="align-middle text-center">
																	...
																	<a href="?p=process-hapus-history-sunter&id=<?= $row['id'] ?>part_no=<?= $row['part_no'] ?>&part_name=<?= $row['part_name'] ?>" class='btn btn-danger btn-sm waves-effect waves-dark'><i class='mdi mdi-delete'> Delete</i></a>-->
																	<a href="?p=process-cetak-data-sunter&id=<?= $row['id'] ?>" class='btn btn-success btn-sm waves-effect waves-dark' target='_blank'><i class='mdi mdi-printer'> Re-Print</i></a>
																</td>
															</tr>
														<?php $i++; } 
													} ?>
