	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-12 col-12 align-self-center">
				<h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-settings"> Edit Kanban Karawang (ADM)</h3></i>
								...
								<?php
									...
									if ($query) {
										while ($row = mysqli_fetch_array($query)) { ?>
											<form action="?p=process-edit-adm-karawang" method="post">
												<input type="hidden" value="<?= $id ?>" name="id" id="id">
												<div class="form-group">
													<label class="font-weight-bold text-uppercase" for="customer_pn">COSTUMER PN</label>
													<input type="text" value="<?= $row['field_26'] ?>" class="form-control" placeholder="Isi disini" name="part_no"  id="part_no">
												</div>
												<div class="form-group">
													<label class="font-weight-bold text-uppercase" for="part_name">NAME</label>
													<input type="text" value="<?= $row['field_27'] ?>" class="form-control" placeholder="Isi disini" name="part_name"  id="part_name">
												</div>
												<div class="form-group">
													<label class="font-weight-bold text-uppercase" for="total_qty">TOTAL QTY</label>
													<input type="text"  value="<?= $row['field_32'] ?>" class="form-control" placeholder="Isi disini" name="total_qty"  id="total_qty">
												</div>
												<div class="form-group">
													<label class="font-weight-bold text-uppercase" for="job_no">JOB NO</label>
													<input type="text"  value="<?= $row['field_28'] ?>" class="form-control" placeholder="Isi disini" name="job_no"  id="job_no">
												</div>
												<div class="form-group">
												...
												<div class="form-group">
													...
													<input type="text"  value="<?= $row['field_10'] ?>" class="form-control" placeholder="Isi disini" name="order_no"  id="order_no">
												</div>
												<div class="form-group">
													...
													<button class="btn btn-danger waves-effect waves-dark" type="button" onclick="location.href='?p=adm-karawang'"><i class="mdi mdi-refresh"> CANCEL</button></a></i>
												</div>
											</form>
										<?php
										}
