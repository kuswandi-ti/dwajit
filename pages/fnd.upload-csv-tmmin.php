    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-12 col-12 align-self-center">
                <h3 class="text-themecolor m-b-0 m-t-0"><i class="mdi mdi-car"> Upload File XLS Toyota</h3></i>
                    ...
                    <div class="col-12">
                        <div class="card">
							<div class="card-body">
								...
								<form class="form-material m-t-40" action="?p=process-upload-csv&cust=TMMIN" method="post" enctype="multipart/form-data" name="import" id="import">									
									<div class="form-group">
										<div class="form-group">
											<div class="demo-radio-button">
												<input name="cust_source" type="radio" id="file_tmmin_karawang" value="karawang" checked />
												<label for="file_tmmin_karawang">KARAWANG</label>
												<input name="cust_source" type="radio" id="file_tmmin_sunter" value="sunter" />
												<label for="file_tmmin_sunter">SUNTER</label>
											</div>
                                        ...
                                        <table id="dataTable" class="table table-bordered table-striped table-hover table-sm">
                                            <thead>
                                                <tr>
													...
													<th class="align-middle text-uppercase">Plant</th>
                                            ...
                                            <tbody>
                                                <?php 
													$no = 1;
													$sql = "SELECT field_82 AS plant,nama_file_source,tanggal_upload,status
															FROM time_kanban
															WHERE customer = 'TMMIN'
															GROUP BY field_82,nama_file_source,tanggal_upload,status";
													$query = mysqli_query($fndMysql, $sql);
													while ($row = mysqli_fetch_array($query)) {
														?>
														<tr>
															<td class="align-middle"><?php echo $no++; ?></td>
															<td class="align-middle"><?= $row['plant']?></td>
